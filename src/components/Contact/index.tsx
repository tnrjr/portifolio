    ...
    return (
        <ContainerContact id="contato">
            ...
            <SubContainerContact>
                ...
                <BoxContact href='mailto:tn-junior@hotmail.com' >
                ...
                <BoxContact target="blank"  href='https://api.whatsapp.com/send?phone=5581984417364' >
                ...
                <BoxCV href={"https://docs.google.com/document/d/1Wih4-lcjdWS74CTBicQRyjLSNEeox4Yt/edit?usp=sharing&ouid=102557712698800424812&rtpof=true&sd=true"} download="Tary Junior - Currículo">
                    <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <BoxTexts>
                        <LinkTextCV>Resume</LinkTextCV>
                    </BoxTexts>
                </BoxCV>

                <ContainerSocialMedias>
                    <SocialMedia target="blank"  href='https://www.linkedin.com/in/tarynascimento'>
                        <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <SocialMedia target="blank"  href='https://github.com/TN-Junior'>
                        <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <SocialMedia target="blank" href='https://instagram.com/taryjunioor'>
